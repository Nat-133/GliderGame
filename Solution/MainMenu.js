export class MainMenu{
    ...
    constructor(){
        ...
        this.mouseControls = document.createElement("div");
        this.mouseControls.innerHTML = "<p text-align: center>click and hold for mouse controls</p>";
        this.mouseControls.style.position = "absolute";
        this.mouseControls.style.top = "35%";
        this.mouseControls.style.left = "50%";
        this.mouseControls.style.transform = "translate(-50%, -50%)";
        this.mouseControls.style.margin = "0";
        this.mouseControls.style.color = "#ffffff";
        this.container.appendChild(this.mouseControls);
